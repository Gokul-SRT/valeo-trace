...
const ChildPartToTypeMasterMapping = ({ modulesprop, screensprop }) => {
  ...
  useEffect(() => {
    ...
    const sampleData = [
      {
        child_pac_map_id: "CPAM001",
        child_part_id: "CODE1",
        type_id: "Description 1",
        tenant_id: "TEN001",
  ...
  const columnDefs = [
    { headerName: "Child Map Id", field: "child_pac_map_id", filter: "agTextColumnFilter" },
  ...
  return (
    <div className="container mt-1">
      <div className="card shadow mt-4" style={{ borderRadius: "6px" }}>
        ...
        >
          Child Part To Type MasterMapping Master Details
          <PlusOutlined
